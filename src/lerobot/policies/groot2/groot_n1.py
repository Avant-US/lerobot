...
from lerobot.policies.groot2.action_head.flow_matching_action_head import (
    FlowmatchingActionHead,
    FlowmatchingActionHeadConfig,
)
from lerobot.policies.groot2.utils import ensure_eagle_cache_ready
...
class GR00TN15(PreTrainedModel):
    ...
    # Compatibility with newer `transformers` versions that expect this attribute
    # during model finalization. GR00T does not define tied weights here.
