...
RAW_DATA="/mnt/r/share/lkx/pi/data/r1_pro_test_data"
# 输出到 /mnt/r (大容量)，然后创建本地 symlink
# (v2.1→v3.0 转换需要两份副本同时存在，本地磁盘空间不够)
OUTPUT_DATA_ACTUAL="/mnt/r/DATA/PI/r1_pro_test_data_v3"
...
echo ""
echo "============================================================"
echo "Phase 3: Pi0.5 验证 — 训练集"
echo "============================================================"
python "$LEROBOT_ROOT/bt/pi05/alig/dataprocess/verify_pi05.py" \
    --dataset-dir "$OUTPUT_DATA_ACTUAL" \
    --run-forward-pass
