...
Usage:
    python -m bt.ptsmolvla.convert_community --num-episodes 37 --output-dir data/community_pt_smolvla
    python -m bt.ptsmolvla.convert_community --num-episodes 5 --output-dir data/community_pt_smolvla  # quick test
"""
...
def convert_community(
    output_dir: str = "data/community_pt_smolvla",
    num_episodes: int = 37,
    seed: int = 42,
    max_probe: int = 120,
):
    ...
    download_plan: list[tuple[str, int, dict, str]] = []
...
if __name__ == "__main__":
    ...
    p.add_argument("--output-dir", default="data/community_pt_smolvla")
